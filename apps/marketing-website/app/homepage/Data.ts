...
export const stepsData = [
    {
      title: 'Apply Online',
      description: 'Fill out a short application with your coaching background, experience, and the services you’d like to offer.',
      imageSrc: adaptive1,
      stepNumber: 1,
    },
    {
    ...
    },
    {
      ...
      description: 'When your profile goes live, you can begin scheduling sessions, connecting with clients, and making an impact.',
      imageSrc: adaptive1,
      stepNumber: 4,
    }
  ];
