...
export const metadata: Metadata = {
	...
	description:
		'Track your fitness progress, book training sessions, and connect with expert trainers. Join our smart training platform for personalized workouts and expert guidance.',
