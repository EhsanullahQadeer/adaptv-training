...
import { ArticleIcon, CalenderIcon, FireIcon, MessageIcon, StackIcon } from '@workspace/ui/icons';
import SessionTabContent from './components/SessionTabContent';

const featureTabs = [
	{ label: 'Session', value: 'session', icon: <FireIcon height={24} width={24} /> },
	{ label: 'Trainers', value: 'trainers', icon: <CalenderIcon height={24} width={24} /> },
	{ label: 'Classes', value: 'classes', icon: <StackIcon height={24} width={24} /> },
	{ label: 'Messages', value: 'messages', icon: <MessageIcon height={24} width={24} /> },
	{ label: 'Profile', value: 'profile', icon: <ArticleIcon height={24} width={24} /> },
];
				...
				<div className="px-4">
					<div className="max-w-[1100px] mx-auto overflow-hidden">
						...
						<div className="mt-6 sm:mt-9 w-full">
							...
							{/* {activeTab === 'trainers' && <SessionsTabContent />}
