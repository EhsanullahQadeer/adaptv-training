...
const PlatfomFeatures = () => {
  ...
  return (
    <div className="pt-20 pb-18 flex flex-col items-center gap-9">
      <h3 className="text-center">A Smarter way to train feature highlights</h3>
      ...
      <div className="flex items-center justify-center border-b border-light-smoke">
        {featureTabs.map((tab, idx) => {
          ...
          return (
            ...
            >
              {icon}
              <p className="text-sm md:text-base font-semibold tracking-[-0.06px] md:tracking-[-0.16px] leading-normal">
                {label}
              </p>
            </div>
          );
