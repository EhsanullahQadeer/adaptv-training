...
export const metadata: Metadata = {
	...
	description:
		'Join our network of expert trainers. Apply to become a certified coach on the Adaptv Training Platform.',
			...
			<div className="flex flex-1 ">
				...
				>
					<div className="flex-1 flex flex-col gap-2 items-center justify-center p-2">
						<Image width={193} height={32} src={adaptvLogo} alt="Adaptv Logo" priority quality={90} />
