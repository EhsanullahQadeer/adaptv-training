...
export const metadata: Metadata = {
	...
	description:
		'Join our network of fitness professionals. Learn how Adaptv Training empowers coaches with smart tools and technology to transform the fitness industry.',
