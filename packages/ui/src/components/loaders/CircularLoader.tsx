...
function CircularLoader({ size = 24, color = 'currentColor', strokeWidth = 2, className }: CircularLoaderProps) {
	return (
		<div className={cn('inline-flex items-center justify-center', className)} role="status" aria-label="Loading">
			...
			>
				<circle className="opacity-25" cx="12" cy="12" r="10" stroke={color} strokeWidth={strokeWidth} />
				<path
